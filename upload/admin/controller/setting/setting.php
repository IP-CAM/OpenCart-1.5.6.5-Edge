...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_image_refine_search'] = $this->language->get('entry_image_refine_search');
		...
		if (isset($this->request->post['config_image_refine_search_width'])) {
			$this->data['config_image_refine_search_width'] = $this->request->post['config_image_refine_search_width'];
		} else {
			$this->data['config_image_refine_search_width'] = $this->config->get('config_image_refine_search_width');
		}

		if (isset($this->request->post['config_image_refine_search_height'])) {
			$this->data['config_image_refine_search_height'] = $this->request->post['config_image_refine_search_height'];
		} else {
			$this->data['config_image_refine_search_height'] = $this->config->get('config_image_refine_search_height');
		}
